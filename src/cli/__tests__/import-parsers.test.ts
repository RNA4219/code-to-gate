        ...
        {},
        {
          ...
          results: [
            ...
            },
            {
              ruleIndex: 1,
              level: "error",
              locations: [{ physicalLocation: { artifactLocation: { uri: "src/b.ts" }, region: { startLine: 4 } } }],
            },
            {
              ruleIndex: 2,
              level: "warning",
              locations: [{ physicalLocation: { artifactLocation: { uri: "src/c.ts" }, region: { startLine: 5 } } }],
            },
            {
              ruleIndex: 3,
              level: "note",
              locations: [{ physicalLocation: { artifactLocation: { uri: "src/d.ts" }, region: { startLine: 6 } } }],
            },
            {
              ruleId: "xss-rule",
              level: "none",
              fingerprints: { primaryLocationLineHash: "fp-two" },
              locations: [{ physicalLocation: { artifactLocation: { uri: "src/e.ts" }, region: { startLine: 7 } } }],
            },
            {
              ruleId: "unknown level",
              level: "other",
              locations: [{ physicalLocation: { artifactLocation: { uri: "src/f.ts" }, region: { startLine: 8 } } }],
            },
            { ruleId: "location-missing", level: "error" },
          ],
        },
      ],
    });
