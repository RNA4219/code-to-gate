...
describe("report-viewer", () => {
  ...
  describe("generateReportHtml", () => {
    ...
    it("uses the findings tool version in the escaped footer", () => {
      const findings = createMockFindings({
        tool: { name: "code-to-gate", version: "1.6.0<&", plugin_versions: [] },
      });
      const html = generateReportHtml({ findings });

      expect(html).toContain("Generated by code-to-gate v1.6.0&lt;&amp;");
      expect(html).not.toContain("Generated by code-to-gate v0.2.0");
    });

    it("uses the readiness tool version when findings are absent", () => {
      const readiness = createMockReadiness({
        tool: { name: "code-to-gate", version: "2.4.0<&", plugin_versions: [] },
      });
      const html = generateReportHtml({ readiness }, { showReadiness: true });

      expect(html).toContain("Generated by code-to-gate v2.4.0&lt;&amp;");
      expect(html).not.toContain("Generated by code-to-gate v0.2.0");
    });

    it("uses the graph tool version when findings and readiness are absent", () => {
      const graph: NormalizedRepoGraph = {
        version: "ctg/v1",
        generated_at: "2026-09-11T00:00:00Z",
        run_id: "graph-run",
        repo: { root: "/repo" },
        tool: { name: "code-to-gate", version: "3.1.0<&", plugin_versions: [] },
      ...
      const html = generateReportHtml({ graph }, { showGraph: true });

      expect(html).toContain("Generated by code-to-gate v3.1.0&lt;&amp;");
      expect(html).not.toContain("Generated by code-to-gate v0.2.0");
    });

    it("marks the footer version as unknown when no artifact provides one", () => {
      const html = generateReportHtml({});

      expect(html).toContain("Generated by code-to-gate vunknown");
      expect(html).not.toContain("Generated by code-to-gate v0.2.0");
    });
